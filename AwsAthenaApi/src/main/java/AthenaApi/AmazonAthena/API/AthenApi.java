...
public class AthenApi {
    ...
    public static String getS3Object(String region, String access_key, String secret_key, String body, Map<String, String> headers1, String request_parameter)
            throws Exception {
        ...
        String authorization = Signature(method,
                host,
                region,
                body,
                secret_key,
